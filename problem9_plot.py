...
f, w, n = values("Scan_broad_interactions_f_0.1_n_40000_w2_2.3")
plt.plot(w,n/100,label="f=0.1")
f, w, n = values("Scan_broad_interactions_f_0.4_n_40000_w2_2.3")
plt.plot(w,n/100,label="f=0.4")
f, w, n = values("Scan_broad_interactions_f_0.7_n_40000_w2_2.3")
plt.plot(w,n/100,label="f=0.7")
plt.legend()
plt.xlabel("frequency (MHz)")
plt.ylabel("Percentage of particles")
